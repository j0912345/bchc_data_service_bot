...
client = commands.Bot(command_prefix=prefix, activity=discord.Game(name='with your save. bot version: v1.1.2.3'))
...
##            print("done!")
            ...
            embed_var.add_field(name="external links:", value="bot source code:\nhttps://github.com/j0912345/bchc_data_service_bot\n\nthe hacking functions the bot uses are based on fiery henry's save editor here:\nhttps://github.com/fieryhenry/Battle-Cats-Save-File-Editor")
            await message.channel.send(embed=embed_var)
